...
const OrderItem = ({ data }) => {
    ...
    return (
       <main>
            ...
            <div key={dictData["key"]} className={'goods-item-contain-disabled' } 
            // onClick={()=>{
            //     console.log("Clicked!")
            ...
            >
                ...
                {/* <p >Remaining: {quantityRemaining}</p> */}

                <div style={{display: "inline-block"}}>
                        <img src={OnStockIcon} alt="Order Quantity" style={{width: "16px", height: "16px"}}/>
                        <p style={{display: "inline-block", paddingLeft: "4px"}}>Remaining: {quantityRemaining}</p>
                </div>
